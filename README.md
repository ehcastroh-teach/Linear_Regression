...
| File | Description |
|------|-------------|
| `hw-m100-linear-regression.ipynb` | Guided homework notebook covering Parts 1-3: summary statistics, single-variable regression, and multi-variable regression |
...
# Launch the notebook
jupyter notebook hw-m100-linear-regression.ipynb
```
